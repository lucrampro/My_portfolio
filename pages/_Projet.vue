  ...
  <div class="projet ">
    ...
    <!-- CONTENT PROJECT  -->
      <div class="wrapper--content">
        <!-- <img v-for="(img, i) in projet.project_img" :key="i" :src="require(`~/assets/imgs/projets/${img}`)"> -->
        <div class="wrapper--img wrapper--first--img">
          <img :src="require(`~/assets/imgs/projets/${projet.project_img.first}`)" alt="">
        </div>

        <div class="wrapper--second--third--img">
          <div class="wrapper--img"><img :src="require(`~/assets/imgs/projets/${projet.project_img.second}`)" alt=""></div>
          <div class="wrapper--img"><img :src="require(`~/assets/imgs/projets/${projet.project_img.third}`)" alt=""></div>
        </div>

        <div class="wrapper--four--img">
          <div class="wrapper--img"><img :src="require(`~/assets/imgs/projets/${projet.project_img.four}`)" alt=""></div>
        </div>
        <div v-if="projet.project_img.five" class="wrapper--five--img">
          <div class="wrapper--img"><img :src="require(`~/assets/imgs/projets/${projet.project_img.five}`)" alt=""></div>
        </div>
      </div>
    <!-- CONTENT PROJECT  -->
